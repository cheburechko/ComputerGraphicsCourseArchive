...
public class Scene extends Observable implements Observer {
	 ...
	 * 
	 * @param a
	 *            first angle around z axis
	 * @param b
	 *            second angle around x axis
	 * @param c
	 *            third angle around z axis
	 */
	...
	/**
	 * Gets normal transformation for the scene
	 * 
	 * @return transformation for the normals of vertices
	 */
